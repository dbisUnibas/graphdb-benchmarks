 ...
 */
public class DistrubutedSingleInsertionBenchmark extends PermutingBenchmarkBase implements InsertsGraphData {
    ...
    public DistrubutedSingleInsertionBenchmark(BenchmarkConfiguration bench ) {
