...
public class TestCACT
{
	...
	private File locationBase = new File("/tmp/hgdb/");
	...
	private HyperGraphPeer startPeer(String dblocation, String username)
	{
		...
		interfaceConfig.set("room", "room1@conference." + hostname);
	...
	@Test
	public void testDefineAtom() throws InterruptedException {
	...
	@Test
	public void testAddAtom() throws InterruptedException {
		HGHandle fromPeer1 = graph1.add("From Peer1");
		HGPeerIdentity pid =  peer2.getIdentity();
		pid.setIpAddress("10.34.58.115");
		pid.setHostname("10.34.58.115");
		peer1.getActivityManager().initiateActivity(new AddAtom(peer1, fromPeer1, pid));
